...
class CouldNotSplitRoyaltyError extends Error {
    constructor() {
        super('Could not split royalty');
        this.code = 0x85;
        this.name = 'CouldNotSplitRoyalty';
        if (typeof Error.captureStackTrace === 'function') {
            Error.captureStackTrace(this, CouldNotSplitRoyaltyError);
        }
    }
}
exports.CouldNotSplitRoyaltyError = CouldNotSplitRoyaltyError;
createErrorFromCodeLookup.set(0x85, () => new CouldNotSplitRoyaltyError());
createErrorFromNameLookup.set('CouldNotSplitRoyalty', () => new CouldNotSplitRoyaltyError());
