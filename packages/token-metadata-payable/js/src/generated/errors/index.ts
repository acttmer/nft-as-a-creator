...
/**
 * CouldNotSplitRoyalty: 'Could not split royalty'
 *
 * @category Errors
 * @category generated
 */
export class CouldNotSplitRoyaltyError extends Error {
  readonly code: number = 0x85
  readonly name: string = 'CouldNotSplitRoyalty'
  constructor() {
